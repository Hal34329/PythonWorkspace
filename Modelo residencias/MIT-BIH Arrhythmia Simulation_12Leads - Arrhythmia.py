...
while True:
    folder_name = f"Simulation_Arr_{folderNum}"
...
ecg_signal = nk.ecg_simulate(duration=10, method="multileads", ti=ti, ai=ai, bi=bi)

# Simulate 30 seconds of ECG Signal (recorded at 250 samples / second)
#ecg_signal = nk.ecg_simulate(duration=30, sampling_rate=360,heart_rate=heart_rate, method="multileads")
""""
